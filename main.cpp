...
void sendMessage() {
    ...
    while (current) {
        if (current->friendName == recipientName)
        {
            ...
            {
                cout << "User is blocked. Can't send message." << endl;
                return;
            }
        }
    ...
    while (current) {
        if (current->friendName == currentUser->name)
        {
            if (current->status == "blocked")
            {
                cout << "You are blocked. Can't send message." << endl;
                return;
            }
        }
        current = current->next;
...
void showMessages()
{
    ...
    cout << "No friend/follower with such user name found." << endl;
}
...
void blockFriend()
{
    ...
    while (current) {
        if (current->friendName == name)
        {
            if (current->status == "blocked")
            {
                cout << "User is already blocked. Itna ghussa?" << endl;
                return;
            }
    ...
    cout << "No follower with such username found." << endl;
}
...
void unblockFriend()
{
    ...
    while (current) {
        if (current->friendName == name)
        {
            ...
            {
                cout << "User is already unblocked. Aap theek to hain na?" << endl;
                return;
            }
...
void viewFollowerNewsfeed()
{
    ...
    while (current) {
        if (current->friendName == currentUser->name)
        {
            ...
            {
                cout << "You've blocked this user. Unblock them to view their posts." << endl;
                return;
            }
        }
        current = current->next;
    }
    cout << "You are not following that user. Follow them to view their posts." << endl;
}